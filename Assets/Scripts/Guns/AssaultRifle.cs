...
public class AssaultRifle : MonoBehaviour, IPrimary, IRestricted, IThrowable, IRanged
{
    private readonly float fireRate = 0.12f; // in seconds, 0.5 seconds between each shot
    private readonly int magCap = 30;
    private int numberOfReloads = 2; // total bullets available can be seen as numberOfReloads*magCap
